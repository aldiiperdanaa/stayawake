...
path = "models/assets/haarcascade_frontalface_default.xml"
faceCascade = cv2.CascadeClassifier(cv2.data.haarcascades + path)
awake = vlc.MediaPlayer(
    "models/assets/Jojo's Bizarre Adventure- Awaken(Pillar Men Theme).mp3")
...
while True:
    ...
    eye_cascade = cv2.CascadeClassifier(
        cv2.data.haarcascades + "models/assets/haarcascade_eye.xml")
